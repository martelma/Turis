    ...
    ILogger<IdentityService> logger) : IIdentityService
{
    ...
    {
        var user = (await GetUserAsync(httpContext.User.GetId()))?.Content;
        return user;
    }
    ...
    {
        var userId = httpContext.User.GetId().ToString();
    ...
    public Task<Result<SecurityCode>> CreateSecurityCodeAsync()
    {
        ...
        {
            UserId = httpContext.User.GetId().ToString(),
            Scopes = httpContext.User.GetScopes()
        };
