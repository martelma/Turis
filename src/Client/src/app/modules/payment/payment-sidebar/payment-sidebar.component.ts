...
import { PaymentSearchParameters } from '../payment.types';
...
export class PaymentSidebarComponent implements OnInit {
    @Input() debounce = 300;
    @Output() onFilterChanged = new EventEmitter<PaymentSearchParameters>();
    ...
    clearFilters() {
        this.parameters = new PaymentSearchParameters();
        this.dateFrom = null;
        this.dateTo = null;
    ...
    _search(paymentParameters: PaymentSearchParameters): void {
        this._paymentService
            .listEntities({ ...this.parameters, ...paymentParameters, pageIndex: 0 })
            .pipe(untilDestroyed(this))
            .subscribe();
    }
}
